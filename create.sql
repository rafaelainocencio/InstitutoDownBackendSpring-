...
create table vaga (id int8 generated by default as identity, carga_horaria varchar(255), descricao varchar(255), nome varchar(255), salario float8, empresa_id int8, primary key (id));
